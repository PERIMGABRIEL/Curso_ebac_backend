...
- `modulos/mod40`
- `modulos/mod42`
- `modulos/mod42-produto`

## Origem das entregas

Os materiais foram preservados a partir dos repositorios individuais abaixo:
...
Maven, entre na pasta dele e use o comando indicado no `pom.xml` ou o wrapper
`mvnw`, quando presente.
